    ...
    public class DR_SaveSlot : MonoBehaviour
    {
        ...
        public void Func_SetSlot(DR_SaveInformation _saveSlot, int _slotNum)
        {
            ...
            if (_saveSlot != null)
            {
                ...
                DateTime _firstTime = Convert.ToDateTime(_saveSlot.saveTime);
                DateTime _SaveTime = Convert.ToDateTime(_saveSlot.playTime);
                ...
                text_PlayTime.text = _saveSlot.playTime;       // 플레이 타임 설정
